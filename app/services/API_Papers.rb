...
require "net/http"
    ...
    def papers
    url = URI("https://api.pappers.fr/v1/recherche?api_token=3e10f34b388926a0e4030180829391e02b3155bef5f069d5&par_page=20&nom_entreprise&code_naf=69.10Z&departement&code_postal&convention_collective=&categorie_juridique&entreprise_cessee&chiffre_affaires_min&chiffre_affaires_max&resultat_min&resultat_max&date_creation_min=01-11-2020&date_creation_max&tranche_effectif_min=&tranche_effectif_max")
